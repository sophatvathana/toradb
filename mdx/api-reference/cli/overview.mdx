...
<ParamField path="--db" type="path" required>
  Database directory.
</ParamField>
<ParamField path="--table" type="str" default="passages">
  Table name.
</ParamField>
<ParamField path="--source" type="str" default="parquet">
  `parquet` or `jsonl`.
</ParamField>
...
<ParamField path="--drop-table" type="flag">
