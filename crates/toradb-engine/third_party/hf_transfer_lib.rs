// Reference copy of Hugging Face hf_transfer (upstream PyO3 bindings).
// Source: https://raw.githubusercontent.com/huggingface/hf_transfer/refs/heads/main/src/lib.rs
//
// ToraDB uses the native Rust port in `src/hf_transfer.rs` (parallel range downloads),
// adapted from this file. This file is kept for attribution and diff reference only.
